        ...
        <div className="container mx-auto flex justify-between items-center">
          ...
          {!token ? (
            ...
            <div className="hidden md:flex items-center space-x-4">
              {/* Profile Icon */}
              <button
                className="p-2 text-gray-700 hover:text-[#bf4221] hover:bg-[#bf4221]/10 rounded-full transition-colors duration-200"
                onClick={goToProfile}
                title="Profile"
              >
                <UserCircle size={24} />
            ...
            {!token ? (
              ...
              <div className="mt-4 space-y-2">
                <div className="flex justify-around mb-2">
                  <button
                    className="p-2 text-gray-700 hover:text-[#bf4221] hover:bg-[#bf4221]/10 rounded-full transition-colors duration-200 flex flex-col items-center"
                    onClick={goToProfile}
                  >
                    <UserCircle size={24} />
